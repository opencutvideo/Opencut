  ...
  return (
    <>
      ...
      >
        ...
        {/* CTAs */}
        <div className={`flex flex-col sm:flex-row items-center gap-3 mb-14 transition-all duration-700 delay-300 ${heroSection.inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <Link
            to="/editor"
            className="inline-flex items-center justify-center gap-2 bg-white text-black font-semibold px-8 py-3.5 rounded-xl hover:bg-white/90 active:scale-[0.97] transition-all duration-150 shadow-[0_0_40px_rgba(255,255,255,0.12)] text-[15px]"
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 border border-white/10 text-white/60 font-medium px-7 py-3.5 rounded-xl hover:border-white/20 hover:text-white/85 hover:bg-white/[0.03] active:scale-[0.97] transition-all duration-150 text-[15px]"
          >
